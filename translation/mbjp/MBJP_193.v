...
{ eapply T_ProgramConcat.
  ...
  { eapply T_ProgramConcat.
    ...
    { eapply T_ProgramConcat.
      ...
      { eapply T_ClassDecl with(name:="RemoveTuple").
        { simpl. try reflexivity. }
        { eapply T_MethodDecl with(modif:="public static")(T:=(TyGeneric1 "List" TyInt))(m:="removeTuple").
          { simpl. try reflexivity. }
          { eapply T_Concat.
          ...
          { eapply T_Concat.
            ...
            { eapply T_Concat.
              ...
              { eapply T_Concat.
                { eapply T_Concat.
                  { eapply T_DeclInit with(T:=(TyGeneric1 "List" TyInt))(x:="answer").
                    { simpl. try reflexivity. }
                  ...
                  { eapply T_Skip. } }
                { eapply T_Concat.
                  { eapply T_Foreach with(T:=TyInt)(x:="integer").
                    { simpl. try reflexivity. }
                    { eapply T_Var with(x:="set").
                      simpl. try reflexivity. }
                    { simpl. try reflexivity. }
