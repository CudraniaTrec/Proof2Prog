...
{ eapply T_ProgramConcat.
  ...
  { eapply T_ProgramConcat.
    ...
    { eapply T_ProgramConcat.
      ...
      { eapply T_ClassDecl with(name:="AllCharactersSame").
        { simpl. try reflexivity. }
        { eapply T_MethodDecl with(modif:="public static")(T:=TyBool)(m:="allCharactersSame").
          { simpl. try reflexivity. }
          { eapply T_Concat.
          ...
          { eapply T_Concat.
            { eapply T_Concat.
              { eapply T_DeclInit with(T:=(TyArray TyChar))(x:="sChars").
                { simpl. try reflexivity. }
                      ...
                      { eapply T_Concat.
                        { eapply T_Expression.
                          ...
                          { eapply T_ArrayAccess.
                            ...
                            { eapply T_Var with(x:="i").
                              simpl. try reflexivity. } }
                          { eapply T_TyMethodInvocation with(m:="toLowerCase")(T:=(TyExternal "Character")).
                            { simpl. try reflexivity. }
                            { simpl. try reflexivity. }
                            { eapply T_List.
                              { eapply T_ArrayAccess.
