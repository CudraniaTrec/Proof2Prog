...
{ eapply T_ProgramConcat.
  ...
  { eapply T_ProgramConcat.
    ...
    { eapply T_ProgramConcat.
      ...
      { eapply T_ClassDecl with(name:="MaxProduct").
        { simpl. try reflexivity. }
        { eapply T_MethodDecl with(modif:="public static")(T:=(TyGeneric1 "List" TyInt))(m:="maxProduct").
          { simpl. try reflexivity. }
          { eapply T_Concat.
          ...
          { eapply T_Concat.
            { eapply T_Concat.
              { eapply T_DeclInit with(T:=(TyGeneric1 "List" TyInt))(x:="maxProduct").
                { simpl. try reflexivity. }
            ...
            { eapply T_Concat.
              { eapply T_Concat.
                { eapply T_DeclInit with(T:=TyInt)(x:="maxProductValue").
                  { simpl. try reflexivity. }
                          ...
                          { eapply T_IfElse.
                            { eapply T_Gt.
                              { eapply T_Var with(x:="product").
                                simpl. try reflexivity. }
                              { eapply T_Var with(x:="maxProductValue").
                                simpl. try reflexivity. }
                              { simpl. try reflexivity. } }
                            { eapply T_Concat.
                              { eapply T_Expression.
                              ...
                              { eapply T_Concat.
                                { eapply T_Expression.
                                  eapply T_Assign.
                                  { eapply T_Var with(x:="maxProduct").
                                    simpl. try reflexivity. }
                                  { eapply T_New' with(T:=(TyGeneric0 "ArrayList")).
                                    { simpl. try reflexivity. }
                                    { eapply T_Nil. } }
