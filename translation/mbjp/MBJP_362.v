  ...
  { eapply T_ProgramConcat.
    ...
    { eapply T_ProgramConcat.
      ...
      { eapply T_ClassDecl with(name:="MaxOccurrences").
        ...
        { eapply T_MethodDecl with(modif:="public static")(T:=(TyExternal "Object"))(m:="maxOccurrences").
          { simpl. try reflexivity. }
          { eapply T_Concat.
          ...
          { eapply T_Concat.
            { eapply T_Concat.
              { eapply T_DeclInit with(T:=(TyGeneric2 "Map" TyInt TyInt))(x:="occurenceMap").
                { simpl. try reflexivity. }
            ...
            { eapply T_Concat.
              ...
              { eapply T_Concat.
                { eapply T_Concat.
                  { eapply T_DeclInit with(T:=(TyGeneric1 "List" TyInt))(x:="maxList").
                    { simpl. try reflexivity. }
                ...
                { eapply T_Concat.
                  { eapply T_Foreach with(T:=TyInt)(x:="i").
                    ...
                    { eapply T_Concat.
                      { eapply T_Concat.
                        { eapply T_DeclInit with(T:=TyInt)(x:="val").
                          { simpl. try reflexivity. }
                          { eapply T_MethodInvocation with(m:="getOrDefault").
                            { eapply T_Var with(x:="occurenceMap").
                              simpl. try reflexivity. }
                            { simpl. try reflexivity. }
                            { simpl. try reflexivity. }
                            { eapply T_List.
