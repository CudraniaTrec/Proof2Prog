...
{ eapply T_ProgramConcat.
  ...
  { eapply T_ProgramConcat.
    ...
    { eapply T_ProgramConcat.
      ...
      { eapply T_ClassDecl with(name:="CountOddSquares").
        { simpl. try reflexivity. }
        { eapply T_MethodDecl with(modif:="public static")(T:=TyInt)(m:="countOddSquares").
          { simpl. try reflexivity. }
          { eapply T_Concat.
          ...
          { eapply T_Concat.
            ...
            { eapply T_Concat.
              { eapply T_For.
                ...
                { eapply T_Concat.
                  { eapply T_Concat.
                    { eapply T_DeclInit with(T:=TyInt)(x:="currSquare").
                      { simpl. try reflexivity. }
                    ...
                    { eapply T_If.
                      { eapply T_Eq.
                        { eapply T_Var with(x:="i").
                          simpl. try reflexivity. }
                        { eapply T_Mul.
                          { eapply T_Var with(x:="currSquare").
                            simpl. try reflexivity. }
                          { eapply T_Var with(x:="currSquare").
                            simpl. try reflexivity. } }
                        { simpl. try reflexivity. } }
