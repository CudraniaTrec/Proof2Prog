...
{ eapply T_ProgramConcat.
  ...
  { eapply T_ProgramConcat.
    ...
    { eapply T_ProgramConcat.
      ...
      { eapply T_ClassDecl with(name:="ReverseVowels").
        { simpl. try reflexivity. }
        { eapply T_MethodDecl with(modif:="public static")(T:=TyString)(m:="reverseVowels").
          { simpl. try reflexivity. }
          { eapply T_Concat.
          ...
          { eapply T_Concat.
            { eapply T_Concat.
              { eapply T_DeclInit with(T:=TyString)(x:="vowels").
                { simpl. try reflexivity. }
                { eapply T_String with(s:="aeiouAEIOU"). }
                { simpl. try reflexivity. } }
              { eapply T_Skip. } }
            { eapply T_Concat.
              { eapply T_Concat.
              ...
              { eapply T_Concat.
                ...
                { eapply T_Concat.
                  ...
                  { eapply T_Concat.
                    ...
                    { eapply T_Concat.
                      { eapply T_Concat.
                        { eapply T_DeclNoInit with(T:=TyChar)(x:="temp").
                          simpl. try reflexivity. }
                        { eapply T_Skip. } }
                      { eapply T_Concat.
                        { eapply T_While.
