...
{ eapply T_ProgramConcat.
  ...
  { eapply T_ProgramConcat.
    ...
    { eapply T_ProgramConcat.
      ...
      { eapply T_ClassDecl with(name:="ExtractFreq").
        { simpl. try reflexivity. }
        { eapply T_MethodDecl with(modif:="public static")(T:=TyInt)(m:="extractFreq").
          { simpl. try reflexivity. }
          { eapply T_Concat.
          ...
          { eapply T_Concat.
            { eapply T_Concat.
              { eapply T_DeclInit with(T:=(TyGeneric1 "List" TyInt))(x:="freqList").
                { simpl. try reflexivity. }
              ...
              { eapply T_Concat.
                ...
                { eapply T_Concat.
                  { eapply T_Concat.
                    ...
                    { eapply T_Skip. } }
                  { eapply T_Concat.
                    { eapply T_Foreach with(T:=TyInt)(x:="freq").
                      { simpl. try reflexivity. }
                      { eapply T_Var with(x:="freqList").
                        simpl. try reflexivity. }
                      { simpl. try reflexivity. }
