...
{ eapply T_ProgramConcat.
  ...
  { eapply T_ProgramConcat.
    ...
    { eapply T_ProgramConcat.
      ...
      { eapply T_ClassDecl with(name:="CapitalWordsSpaces").
        { simpl. try reflexivity. }
        { eapply T_MethodDecl with(modif:="public static")(T:=TyString)(m:="capitalWordsSpaces").
          { simpl. try reflexivity. }
          { eapply T_Concat.
                    ...
                    { eapply T_Concat.
                      { eapply T_Expression.
                        ...
                        { eapply T_Add.
                          ...
                          { eapply T_Add.
                            { eapply T_String with(s:=" "). }
                            { eapply T_TyMethodInvocation with(m:="toUpperCase")(T:=(TyExternal "Character")).
                              { simpl. try reflexivity. }
                              { simpl. try reflexivity. }
                              { eapply T_List.
                                { eapply T_MethodInvocation with(m:="charAt").
