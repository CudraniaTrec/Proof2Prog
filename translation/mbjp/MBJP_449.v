...
{ eapply T_ProgramConcat.
  ...
  { eapply T_ProgramConcat.
    ...
    { eapply T_ProgramConcat.
      ...
      { eapply T_ClassDecl with(name:="CheckTriangle").
        { simpl. try reflexivity. }
        { eapply T_MethodDecl with(modif:="public static")(T:=TyString)(m:="checkTriangle").
          { simpl. try reflexivity. }
          { eapply T_Concat.
              ...
              { eapply T_Concat.
                ...
                { eapply T_Concat.
                  { eapply T_DeclNoInit with(T:=TyInt)(x:="y2").
                    simpl. try reflexivity. }
                  { eapply T_Concat.
                    { eapply T_DeclNoInit with(T:=TyInt)(x:="x3").
                      simpl. try reflexivity. }
                    { eapply T_Concat.
                      { eapply T_DeclNoInit with(T:=TyInt)(x:="y3").
                        simpl. try reflexivity. }
                      { eapply T_Skip. } } } } } } }
          { simpl. try reflexivity. }
          { eapply T_Concat.
