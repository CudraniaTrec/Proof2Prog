...
{ eapply T_ProgramConcat.
  ...
  { eapply T_ProgramConcat.
    ...
    { eapply T_ProgramConcat.
      ...
      { eapply T_ClassDecl with(name:="DigitDistanceNums").
        { simpl. try reflexivity. }
        { eapply T_MethodDecl with(modif:="public static")(T:=TyInt)(m:="digitDistanceNums").
          { simpl. try reflexivity. }
          { eapply T_Concat.
          ...
          { eapply T_Concat.
            ...
            { eapply T_Concat.
              { eapply T_While.
                ...
                { eapply T_Concat.
                  { eapply T_Concat.
                    { eapply T_DeclInit with(T:=TyInt)(x:="r1").
                      { simpl. try reflexivity. }
                      { eapply T_Mod.
                        { eapply T_Var with(x:="n1").
                          simpl. try reflexivity. }
                  ...
                  { eapply T_Concat.
                    { eapply T_Concat.
                      { eapply T_DeclInit with(T:=TyInt)(x:="r2").
                        { simpl. try reflexivity. }
                        { eapply T_Mod.
                          { eapply T_Var with(x:="n2").
                            simpl. try reflexivity. }
