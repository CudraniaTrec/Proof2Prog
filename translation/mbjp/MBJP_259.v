...
{ eapply T_ProgramConcat.
  ...
  { eapply T_ProgramConcat.
    ...
    { eapply T_ProgramConcat.
      ...
      { eapply T_ClassDecl with(name:="MaximizeElements").
        { simpl. try reflexivity. }
        { eapply T_MethodDecl with(modif:="public static")(T:=(TyGeneric1 "List" (TyGeneric1 "List" TyInt)))(m:="maximizeElements").
          { simpl. try reflexivity. }
          { eapply T_Concat.
            { eapply T_DeclNoInit with(T:=(TyGeneric1 "List" (TyGeneric1 "List" TyInt)))(x:="testTup1").
              simpl. try reflexivity. }
            { eapply T_Concat.
              { eapply T_DeclNoInit with(T:=(TyGeneric1 "List" (TyGeneric1 "List" TyInt)))(x:="testTup2").
                simpl. try reflexivity. }
              { eapply T_Skip. } } }
          { simpl. try reflexivity. }
          { eapply T_Concat.
            ...
            { eapply T_Concat.
              { eapply T_For.
                ...
                { eapply T_Concat.
                  { eapply T_Concat.
                    { eapply T_DeclInit with(T:=(TyGeneric1 "List" TyInt))(x:="temp1").
                      { simpl. try reflexivity. }
                  ...
                  { eapply T_Concat.
                    { eapply T_Concat.
                      { eapply T_DeclInit with(T:=(TyGeneric1 "List" TyInt))(x:="temp2").
                        { simpl. try reflexivity. }
                        { eapply T_MethodInvocation with(m:="get").
                    ...
                    { eapply T_Concat.
                      ...
                      { eapply T_Concat.
                        { eapply T_For.
                          ...
                          { eapply T_Concat.
                            { eapply T_Concat.
                              { eapply T_DeclInit with(T:=TyInt)(x:="temp1x").
                                { simpl. try reflexivity. }
                                { eapply T_MethodInvocation with(m:="get").
                                  { eapply T_Var with(x:="temp1").
                                    simpl. try reflexivity. }
                            ...
                            { eapply T_Concat.
                              { eapply T_Concat.
                                { eapply T_DeclInit with(T:=TyInt)(x:="temp2x").
                                  { simpl. try reflexivity. }
                                  { eapply T_MethodInvocation with(m:="get").
                                ...
                                { eapply T_Concat.
                                  { eapply T_DeclInit with(T:=TyInt)(x:="temp").
                                    ...
                                    { eapply T_TyMethodInvocation with(m:="max")(T:=(TyExternal "Math")).
                                      ...
                                      { simpl. try reflexivity. }
                                      { eapply T_List.
                                        { eapply T_Var with(x:="temp1x").
                                          simpl. try reflexivity. }
                                        { eapply T_List.
                                          { eapply T_Var with(x:="temp2x").
                                            simpl. try reflexivity. }
                                          { eapply T_Nil. } } }
                                      { simpl. try reflexivity. } }
                                    { simpl. try reflexivity. } }
