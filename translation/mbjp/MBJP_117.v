...
{ eapply T_ProgramConcat.
  ...
  { eapply T_ProgramConcat.
    ...
    { eapply T_ProgramConcat.
      ...
      { eapply T_ClassDecl with(name:="ListToFloat").
        { simpl. try reflexivity. }
        { eapply T_MethodDecl with(modif:="public static")(T:=TyString)(m:="listToFloat").
          { simpl. try reflexivity. }
          { eapply T_Concat.
                        ...
                        { eapply T_Add.
                          { eapply T_Add.
                            { eapply T_Add.
                              ...
                              { eapply T_TyMethodInvocation with(m:="valueOf")(T:=(TyExternal "Double")).
                                { simpl. try reflexivity. }
                                { simpl. try reflexivity. }
                                { eapply T_List.
