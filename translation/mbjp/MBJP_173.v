...
{ eapply T_ProgramConcat.
  ...
  { eapply T_ProgramConcat.
    ...
    { eapply T_ProgramConcat.
      ...
      { eapply T_ClassDecl with(name:="RemoveSplchar").
        { simpl. try reflexivity. }
        { eapply T_MethodDecl with(modif:="public static")(T:=TyString)(m:="removeSplchar").
          { simpl. try reflexivity. }
          { eapply T_Concat.
              ...
              { eapply T_Concat.
                { eapply T_For.
                  ...
                  { eapply T_Concat.
                    ...
                    { eapply T_Concat.
                      { eapply T_If.
                        { eapply T_TyMethodInvocation with(m:="isLetterOrDigit")(T:=(TyExternal "Character")).
                          { simpl. try reflexivity. }
                          { simpl. try reflexivity. }
                          { eapply T_List.
