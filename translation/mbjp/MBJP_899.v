  ...
  { eapply T_ProgramConcat.
    ...
    { eapply T_ProgramConcat.
      ...
      { eapply T_ClassDecl with(name:="Check").
        ...
        { eapply T_MethodDecl with(modif:="public static")(T:=TyBool)(m:="check").
          { simpl. try reflexivity. }
          { eapply T_Concat.
          ...
          { eapply T_Concat.
            ...
            { eapply T_Concat.
              { eapply T_Concat.
                { eapply T_DeclInit with(T:=TyBool)(x:="has").
                  { simpl. try reflexivity. }
                  { eapply T_True. }
                  { simpl. try reflexivity. } }
                { eapply T_Skip. } }
              { eapply T_Concat.
                { eapply T_Concat.
                  { eapply T_DeclInit with(T:=(TyArray TyInt))(x:="tempArr").
                    { simpl. try reflexivity. }
                ...
                { eapply T_Concat.
                  ...
                  { eapply T_Concat.
                    { eapply T_Concat.
                      { eapply T_DeclInit with(T:=TyBool)(x:="isSorted").
                        { simpl. try reflexivity. }
                        { eapply T_False. }
                        { simpl. try reflexivity. } }
                      { eapply T_Skip. } }
