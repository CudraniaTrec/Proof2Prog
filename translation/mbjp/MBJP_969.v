...
{ eapply T_ProgramConcat.
  ...
  { eapply T_ProgramConcat.
    ...
    { eapply T_ProgramConcat.
      ...
      { eapply T_ClassDecl with(name:="JoinTuples").
        { simpl. try reflexivity. }
        { eapply T_MethodDecl with(modif:="public static")(T:=(TyGeneric1 "List" (TyGeneric1 "List" TyInt)))(m:="joinTuples").
          { simpl. try reflexivity. }
          { eapply T_Concat.
          ...
          { eapply T_Concat.
            { eapply T_Concat.
              { eapply T_DeclInit with(T:=(TyGeneric2 "HashMap" TyInt (TyGeneric1 "List" TyInt)))(x:="joinedTuples").
                { simpl. try reflexivity. }
              ...
              { eapply T_Skip. } }
            { eapply T_Concat.
              { eapply T_Foreach with(T:=(TyGeneric1 "List" TyInt))(x:="tuple").
                { simpl. try reflexivity. }
                ...
                { eapply T_Concat.
                  { eapply T_IfElse.
                    { eapply T_MethodInvocation with(m:="containsKey").
                      { eapply T_Var with(x:="joinedTuples").
                        simpl. try reflexivity. }
                      { simpl. try reflexivity. }
                      { simpl. try reflexivity. }
                      { eapply T_List.
                    ...
                    { eapply T_Concat.
                      { eapply T_Concat.
                        { eapply T_DeclInit with(T:=(TyGeneric1 "List" TyInt))(x:="newTuple").
                          { simpl. try reflexivity. }
              ...
              { eapply T_Concat.
                { eapply T_Concat.
                  ...
                  { eapply T_Skip. } }
                { eapply T_Concat.
                  { eapply T_Foreach with(T:=TyInt)(x:="key").
                    { simpl. try reflexivity. }
