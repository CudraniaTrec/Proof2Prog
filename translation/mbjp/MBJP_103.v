...
{ eapply T_ProgramConcat.
  ...
  { eapply T_ProgramConcat.
    ...
    { eapply T_ProgramConcat.
      ...
      { eapply T_ClassDecl with(name:="EulerianNum").
        { simpl. try reflexivity. }
        { eapply T_MethodDecl with(modif:="public static")(T:=TyInt)(m:="eulerianNum").
          { simpl. try reflexivity. }
          { eapply T_Concat.
                      ...
                      { eapply T_Mul.
                        { eapply T_Sub.
                          ...
                          { eapply T_Var with(x:="m").
                            simpl. try reflexivity. }
                          { simpl. try reflexivity. } }
                        { eapply T_MethodInvocationNoObj with(m:="eulerianNum").
                          { simpl. try reflexivity. }
                          { eapply T_List.
                            { eapply T_Sub.
                              { eapply T_Var with(x:="n").
