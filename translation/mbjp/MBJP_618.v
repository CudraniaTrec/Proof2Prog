...
{ eapply T_ProgramConcat.
  ...
  { eapply T_ProgramConcat.
    ...
    { eapply T_ProgramConcat.
      ...
      { eapply T_ClassDecl with(name:="DivList").
        { simpl. try reflexivity. }
        { eapply T_MethodDecl with(modif:="public static")(T:=(TyGeneric1 "List" TyDouble))(m:="divList").
          { simpl. try reflexivity. }
          { eapply T_Concat.
          ...
          { eapply T_Concat.
            ...
            { eapply T_Concat.
              { eapply T_Concat.
                { eapply T_DeclInit with(T:=(TyGeneric1 "List" TyDouble))(x:="res").
                  { simpl. try reflexivity. }
                ...
                { eapply T_For.
                  ...
                  { eapply T_Concat.
                    { eapply T_Expression.
                      ...
                      { eapply T_List.
                        { eapply T_Div.
                          { eapply T_MethodInvocation with(m:="doubleValue").
