  ...
  { eapply T_ProgramConcat.
    ...
    { eapply T_ProgramConcat.
      ...
      { eapply T_ClassDecl with(name:="MaxProduct").
        ...
        { eapply T_MethodDecl with(modif:="public static")(T:=TyInt)(m:="maxProduct").
          { simpl. try reflexivity. }
          { eapply T_Concat.
          ...
          { eapply T_Concat.
            { eapply T_Concat.
              { eapply T_DeclInit with(T:=TyInt)(x:="maxProduct").
                { simpl. try reflexivity. }
            ...
            { eapply T_Concat.
              { eapply T_Concat.
                { eapply T_DeclInit with(T:=(TyArray TyInt))(x:="maxMultipliers").
                  { simpl. try reflexivity. }
                  ...
                  { eapply T_Concat.
                    { eapply T_Expression.
                      ...
                      { eapply T_ArrayAccess.
                        { eapply T_Var with(x:="maxMultipliers").
                          simpl. try reflexivity. }
                        { eapply T_Var with(x:="i").
                          simpl. try reflexivity. } }
