...
{ eapply T_ProgramConcat.
  ...
  { eapply T_ProgramConcat.
    ...
    { eapply T_ProgramConcat.
      ...
      { eapply T_ClassDecl with(name:="RemoveWhitespaces").
        { simpl. try reflexivity. }
        { eapply T_MethodDecl with(modif:="public static")(T:=TyString)(m:="removeWhitespaces").
          { simpl. try reflexivity. }
          { eapply T_Concat.
          ...
          { eapply T_Concat.
            ...
            { eapply T_Concat.
              { eapply T_Concat.
                { eapply T_DeclInit with(T:=(TyArray TyString))(x:="ss").
                  { simpl. try reflexivity. }
              ...
              { eapply T_Concat.
                ...
                { eapply T_Concat.
                  ...
                  { eapply T_Concat.
                    { eapply T_Concat.
                      { eapply T_DeclInit with(T:=TyBool)(x:="b").
                        { simpl. try reflexivity. }
                        { eapply T_True. }
                        { simpl. try reflexivity. } }
                      { eapply T_Skip. } }
