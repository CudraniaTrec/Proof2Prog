...
{ eapply T_ProgramConcat.
  ...
  { eapply T_ProgramConcat.
    ...
    { eapply T_ProgramConcat.
      ...
      { eapply T_ClassDecl with(name:="CountPrimesNums").
        { simpl. try reflexivity. }
        { eapply T_MethodDecl with(modif:="public static")(T:=TyInt)(m:="countPrimesNums").
          { simpl. try reflexivity. }
          { eapply T_Concat.
                  ...
                  { eapply T_Concat.
                    ...
                    { eapply T_Concat.
                      ...
                      { eapply T_Concat.
                        { eapply T_Return.
                          { eapply T_Add.
                            { eapply T_MethodInvocationNoObj with(m:="countPrimesNums").
                              { simpl. try reflexivity. }
                              { eapply T_List.
                                { eapply T_Sub.
                                  { eapply T_Var with(x:="n").
