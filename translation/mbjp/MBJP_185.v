...
{ eapply T_ProgramConcat.
  ...
  { eapply T_ProgramConcat.
    ...
    { eapply T_ProgramConcat.
      ...
      { eapply T_ClassDecl with(name:="ParabolaFocus").
        { simpl. try reflexivity. }
        { eapply T_MethodDecl with(modif:="public static")(T:=(TyGeneric1 "List" TyDouble))(m:="parabolaFocus").
          { simpl. try reflexivity. }
          { eapply T_Concat.
          ...
          { eapply T_Concat.
            { eapply T_Concat.
              { eapply T_DeclInit with(T:=(TyGeneric1 "List" TyDouble))(x:="focus").
                { simpl. try reflexivity. }
                ...
                { eapply T_Concat.
                  ...
                  { eapply T_Concat.
                    { eapply T_Expression.
                      ...
                      { simpl. try reflexivity. }
                      { eapply T_List.
                        { eapply T_Float with(f:=1.6%float). }
                        { eapply T_Nil. } }
                      { simpl. try reflexivity. } }
                    { eapply T_Skip. } } } }
              { eapply T_Concat.
                  ...
                  { eapply T_Concat.
                    ...
                    { eapply T_Concat.
                      { eapply T_Expression.
                        ...
                        { simpl. try reflexivity. }
                        { eapply T_List.
                          { eapply T_Float with(f:=2.25%float). }
                          { eapply T_Nil. } }
                        { simpl. try reflexivity. } }
                      { eapply T_Skip. } } } }
                { eapply T_Concat.
                    ...
                    { eapply T_Concat.
                      ...
                      { eapply T_Concat.
                        { eapply T_Expression.
                          ...
                          { simpl. try reflexivity. }
                          { eapply T_List.
                            { eapply T_Float with(f:=4.125%float). }
                            { eapply T_Nil. } }
                          { simpl. try reflexivity. } }
                        { eapply T_Skip. } } } }
                  { eapply T_Concat.
