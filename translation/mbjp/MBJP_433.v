...
{ eapply T_ProgramConcat.
  ...
  { eapply T_ProgramConcat.
    ...
    { eapply T_ProgramConcat.
      ...
      { eapply T_ClassDecl with(name:="CheckGreater").
        { simpl. try reflexivity. }
        { eapply T_MethodDecl with(modif:="public static")(T:=TyString)(m:="checkGreater").
          { simpl. try reflexivity. }
          { eapply T_Concat.
          ...
          { eapply T_Concat.
            { eapply T_Concat.
              { eapply T_DeclInit with(T:=TyString)(x:="result").
                { simpl. try reflexivity. }
                { eapply T_String with(s:="No, entered number is less than those in the array"). }
                { simpl. try reflexivity. } }
              { eapply T_Skip. } }
            { eapply T_Concat.
              { eapply T_If.
              ...
              { eapply T_Concat.
                ...
                { eapply T_Concat.
                  { eapply T_Return.
                    { eapply T_String with(s:="Yes, the entered number is greater than those in the array"). }
                    { simpl. try reflexivity. }
                    { simpl. try reflexivity. } }
                  { eapply T_Skip. } } } } } } } } } }
  Unshelve.
