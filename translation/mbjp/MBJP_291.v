...
{ eapply T_ProgramConcat.
  ...
  { eapply T_ProgramConcat.
    ...
    { eapply T_ProgramConcat.
      ...
      { eapply T_ClassDecl with(name:="CountNoOfWays").
        { simpl. try reflexivity. }
        { eapply T_MethodDecl with(modif:="public static")(T:=TyInt)(m:="countNoOfWays").
          { simpl. try reflexivity. }
          { eapply T_Concat.
          ...
          { eapply T_Concat.
            { eapply T_Concat.
              { eapply T_DeclInit with(T:=(TyArray TyInt))(x:="memo").
                { simpl. try reflexivity. }
                              ...
                              { eapply T_Mul.
                                ...
                                { eapply T_ArrayAccess.
                                  ...
                                  { eapply T_Sub.
                                    ...
                                    { eapply T_Integer with(n:=1). }
                                    { simpl. try reflexivity. } } } }
                              { eapply T_Integer with(n:=1000000007). } }
                            { eapply T_Mod.
                              { eapply T_Mul.
                                { eapply T_Sub.
                                  { eapply T_Var with(x:="k").
