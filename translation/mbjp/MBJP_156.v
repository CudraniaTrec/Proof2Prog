...
{ eapply T_ProgramConcat.
  ...
  { eapply T_ProgramConcat.
    ...
    { eapply T_ProgramConcat.
      ...
      { eapply T_ClassDecl with(name:="TupleIntStr").
        { simpl. try reflexivity. }
        { eapply T_MethodDecl with(modif:="public static")(T:=(TyGeneric1 "List" (TyGeneric1 "List" TyInt)))(m:="tupleIntStr").
          { simpl. try reflexivity. }
          { eapply T_Concat.
            { eapply T_DeclNoInit with(T:=(TyGeneric1 "List" (TyGeneric1 "List" TyString)))(x:="tupleStr").
              simpl. try reflexivity. }
            { eapply T_Skip. } }
          { simpl. try reflexivity. }
          { eapply T_Concat.
              ...
              { eapply T_For.
                ...
                { eapply T_Concat.
                  { eapply T_Expression.
                    ...
                    { simpl. try reflexivity. } }
                  { eapply T_Concat.
                    { eapply T_Foreach with(T:=TyString)(x:="str").
                      { simpl. try reflexivity. }
