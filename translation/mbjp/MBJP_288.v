...
{ eapply T_ProgramConcat.
  ...
  { eapply T_ProgramConcat.
    ...
    { eapply T_ProgramConcat.
      ...
      { eapply T_ClassDecl with(name:="ModularInverse").
        { simpl. try reflexivity. }
        { eapply T_MethodDecl with(modif:="public static")(T:=TyInt)(m:="modularInverse").
          { simpl. try reflexivity. }
          { eapply T_Concat.
          ...
          { eapply T_Concat.
            { eapply T_Concat.
              { eapply T_DeclInit with(T:=TyInt)(x:="currentElement").
                { simpl. try reflexivity. }
              ...
              { eapply T_For.
                ...
                { eapply T_Concat.
                  { eapply T_If.
                    ...
                    { eapply T_Expression.
                      eapply T_PostInc.
                      eapply T_Var with(x:="currentElement").
                      simpl. try reflexivity. } }
                  { eapply T_Skip. } } }
              { eapply T_Concat.
                { eapply T_Return.
