...
{ eapply T_ProgramConcat.
  ...
  { eapply T_ProgramConcat.
    ...
    { eapply T_ProgramConcat.
      ...
      { eapply T_ClassDecl with(name:="CountChar").
        { simpl. try reflexivity. }
        { eapply T_MethodDecl with(modif:="public static")(T:=TyInt)(m:="countChar").
          { simpl. try reflexivity. }
          { eapply T_Concat.
          ...
          { eapply T_Concat.
            ...
            { eapply T_Concat.
              ...
              { eapply T_Concat.
                { eapply T_Concat.
                  { eapply T_DeclInit with(T:=TyInt)(x:="repititions").
                    { simpl. try reflexivity. }
                    { eapply T_Div.
                    ...
                    { eapply T_Concat.
                      { eapply T_Expression.
                        ...
                        { eapply T_Mul.
                          { eapply T_Var with(x:="count").
                            simpl. try reflexivity. }
                          { eapply T_Var with(x:="repititions").
                            simpl. try reflexivity. } }
                        { simpl. try reflexivity. } }
                      { eapply T_Concat.
                        { eapply T_Expression.
