...
{ eapply T_ProgramConcat.
  ...
  { eapply T_ProgramConcat.
    ...
    { eapply T_ProgramConcat.
      ...
      { eapply T_ClassDecl with(name:="RemoveNested").
        { simpl. try reflexivity. }
        { eapply T_MethodDecl with(modif:="public static")(T:=(TyGeneric1 "List" TyInt))(m:="removeNested").
          { simpl. try reflexivity. }
          { eapply T_Concat.
              ...
              { eapply T_For.
                ...
                { eapply T_Concat.
                  { eapply T_IfElse.
                    ...
                    { eapply T_Concat.
                      { eapply T_Concat.
                        { eapply T_DeclInit with(T:=(TyGeneric1 "List" (TyExternal "Object")))(x:="arr").
                          { simpl. try reflexivity. }
