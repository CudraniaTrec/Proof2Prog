...
{ eapply T_ProgramConcat.
  ...
  { eapply T_ProgramConcat.
    ...
    { eapply T_ProgramConcat.
      ...
      { eapply T_ClassDecl with(name:="MostOccurrences").
        { simpl. try reflexivity. }
        { eapply T_MethodDecl with(modif:="public static")(T:=TyString)(m:="mostOccurrences").
          { simpl. try reflexivity. }
          { eapply T_Concat.
          ...
          { eapply T_Concat.
            { eapply T_Concat.
              { eapply T_DeclInit with(T:=(TyGeneric2 "HashMap" TyString TyInt))(x:="count").
                { simpl. try reflexivity. }
            ...
            { eapply T_Concat.
              ...
              { eapply T_Concat.
                { eapply T_Concat.
                  { eapply T_DeclInit with(T:=(TyGeneric2 "Map.Entry" TyString TyInt))(x:="max").
                    { simpl. try reflexivity. }
                    { eapply T_TyMethodInvocation with(m:="max")(T:=(TyExternal "Collections")).
                      { simpl. try reflexivity. }
                      { simpl. try reflexivity. }
                      { eapply T_List.
                        { eapply T_MethodInvocation with(m:="entrySet").
                          ...
                          { simpl. try reflexivity. } }
                        { eapply T_List.
                          { eapply T_MethodInvocation with(m:="comparingByValue").
                            { eapply T_FieldAccess with(f:="Entry").
