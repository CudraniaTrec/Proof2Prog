...
{ eapply T_ProgramConcat.
  ...
  { eapply T_ProgramConcat.
    ...
    { eapply T_ProgramConcat.
      ...
      { eapply T_ClassDecl with(name:="DictFilter").
        { simpl. try reflexivity. }
        { eapply T_MethodDecl with(modif:="public static")(T:=(TyGeneric2 "HashMap" TyString TyInt))(m:="dictFilter").
          { simpl. try reflexivity. }
          { eapply T_Concat.
            { eapply T_DeclNoInit with(T:=(TyGeneric2 "HashMap" TyString TyInt))(x:="dict").
              simpl. try reflexivity. }
            { eapply T_Concat.
          ...
          { eapply T_Concat.
            { eapply T_Concat.
              { eapply T_DeclInit with(T:=(TyGeneric2 "HashMap" TyString TyInt))(x:="freq").
                { simpl. try reflexivity. }
            ...
            { eapply T_Concat.
              { eapply T_If.
                ...
                { eapply T_Return.
                  ...
                  { simpl. try reflexivity. } } }
              { eapply T_Concat.
                { eapply T_Foreach with(T:=(TyGeneric2 "Map.Entry" TyString TyInt))(x:="e").
                  { simpl. try reflexivity. }
